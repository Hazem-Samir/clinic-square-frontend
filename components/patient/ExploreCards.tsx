    ...
    <section className="grid md:grid-cols-2 gap-6">
      <Card className="overflow-hidden bg-card">
        ...
        <CardContent className="p-6">
          ...
          inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-10 px-4 py-2 bg-teal-400 text-primary-foreground hover:bg-teal-400/90">Go to Go to Pharmacies</Link>
        </CardContent>
      </Card>
      <Card className="overflow-hidden bg-card">
        <div className="relative h-48">
