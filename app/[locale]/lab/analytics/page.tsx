...
const Reservations = monthNames.map((key, index) => {
  ...
  <DashboardCharts chartsData={[Reservations,Revenues,[{pendingActors:TotalRevnue}]]} titles={['Reservations',"REM"]} descriptions={[`Jan-Dec`,`Jan-Dec`,["Total_Revenue",`in`]]} role='Lab'/>
