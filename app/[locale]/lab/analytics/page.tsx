...
import { getReservationsStat } from '@/lib/lab/api'
...
const Reservations = monthNames.map((key, index) => {
  ...
  <DashboardCharts chartsData={[Reservations,Revenues,[{pendingActors:TotalRevnue}]]} titles={['Reservations',"REM"]} descriptions={[`Jan-Dec`,`Jan-Dec`,["Total_Revenue",`in`]]} role='Lab' year={parseInt(year)}/>

  )
}
export default function DoctoLabStats({ searchParams }: { searchParams: { year?: string } }) {
