...
export async function GET(request: NextRequest) {
      ...
      try {
        const apiResponse = await fetch(`${SERVER_URL}/lab/My-Reservations?page=${page}&limit=${limit}&state=completed&populate=requestedTests.testDetails.test=name&keyword[patient]=${keyword}`, {
          headers: {
