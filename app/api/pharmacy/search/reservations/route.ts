...
export async function GET(request: NextRequest) {
      ...
      try {
        const apiResponse = await fetch(`${SERVER_URL}/lab/My-Reservations?page=${page}&limit=${limit}&populate=requestedTests.testDetails.test=name&state=new&keyword[patient]=${keyword}`, {
          headers: {
