...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const apiResponse = await fetch(`${SERVER_URL}/pharmacy/newMedicine`, {
      method: 'POST',
      headers: {
    ...
    return NextResponse.json({ success: true, message: 'Medicine Requested, when admin approves we will send you email', data });
