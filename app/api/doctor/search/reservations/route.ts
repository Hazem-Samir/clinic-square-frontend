...
export async function GET(request: NextRequest) {
      ...
      try {
        const apiResponse = await fetch(`${SERVER_URL}/doctor/My-Reservations?page=${page}&limit=${limit}&or[0][state]=pending&or[1][state]=consultaion&keyword[patient]=${keyword}`, {
          headers: {
